  ...
  System.register([], function (exports, module) {
    ...
    return {
      execute: function execute() {
        var TUNASYNC_JSON_PATH = exports("T", "/static/tunasync.json");
        var ISOINFO_JSON_PATH = exports("I", "/static/status/isoinfo.json");
        var DISKINFO_JSON_PATH = exports("D", "/static/status/disk.json");
        var options = exports("o", {
          "mirror_desc": [{
            "name": "AdoptOpenJDK",
            ...
            "name": "chromiumos",
            "desc": "Google Chrome OS 的开放源代码开发版本"
          }, {
            "name": "clickhouse",
            ...
            "desc": "为各大 Linux 发行版提供的 Erlang 软件包"
          }, {
            "name": "fdroid",
            "desc": "F-Droid 是 Android 上的自由与开源软件应用商店"
          }, {
            "name": "fedora",
            ...
            "desc": "GitLab 持续集成框架，已更名为 gitlab-runner"
          }, {
            "name": "gitlab-ee",
            "desc": "Gitlab 企业版"
          }, {
            ...
            "name": "julia",
            "desc": "Julia 编程语言的包管理器镜像"
          }, {
            "name": "julia-general.git",
            "desc": "Julia 软件包注册表"
          }, {
            "name": "julia-releases",
            "desc": "Julia 二进制程序镜像"
            ...
            "name": "kde-neon",
            "desc": "KDE社区维护的一个基于Ubuntu LTS的Linux发行版"
          }, {
            "name": "kernel",
            "desc": "各个版本的 Linux 内核源代码压缩包和补丁"
          }, {
            "name": "kicad",
            "desc": "开源的电路原理图与 PCB 设计工具"
          }, {
            "name": "kodi",
            "desc": "开源的多媒体播放器，原名 XBMC"
          }, {
            "name": "kubernetes",
            "desc": "Kubernetes 是用于集群自动部署和管理的开源系统"
          }, {
            "name": "libreoffice",
            "desc": "自由的办公软件套件"
          }, {
            ...
            "name": "lyx",
            "desc": "所见即所指的 LaTeX 编辑器"
          }, {
            "name": "macports",
            "desc": "macOS 的一个开源软件包管理系统"
          }, {
            "name": "mageia",
            "desc": "Mageia Linux（衍生于 Mandriva Linux）的安装镜像和官方软件包仓库"
          }, {
            "name": "manjaro",
            ...
            "name": "mxlinux",
            "desc": "基于 Debian 的中量级的 Linux 发行版"
          }, {
            "name": "mxlinux-isos",
            "desc": "MX Linux 的安装镜像"
          }, {
            "name": "mysql",
            "desc": "MySQL 数据库的安装包及各种工具下载"
          }, {
            "name": "neurodebian",
            ...
            "name": "OpenMediaVault",
            "desc": "基于 Debian Linux 的网络附加存储(NAS)解决方案"
          }, {
            "name": "openresty",
            ...
            "name": "qubesos",
            "desc": "一个面向安全的桌面操作系统，利用虚拟化技术隔离应用来提供安全保障"
          }, {
            "name": "qt",
            "desc": "跨平台软件开发库 Qt 的源码、开发工具、文档等"
          }, {
            "name": "racket-installers",
            "desc": "Racket 语言环境安装包"
          }, {
            "name": "raspberrypi",
            ...
            "name": "redhat",
            "desc": "Red Hat Enterprise Linux 源码包（SRPM）仓库"
          }, {
            "name": "remi",
          ...
          "new_mirrors": ["mozilla", "debian-elts"],
          "unlisted_mirrors": [{
            "link_to": "sourceware",
            "last_update": "-",
            "name": "cygwin",
          ...
          "force_redirect_help_mirrors": ["lineageOS", "homebrew", "linux.git", "linux-next.git", "linux-stable.git", "git-repo", "gentoo-portage.git", "chromiumos", "weave", "CocoaPods", "llvm", "llvm-project.git", "openthos-src", "qemu.git", "linux-firmware.git", "gcc.git", "crates.io-index.git", "binutils-gdb.git", "glibc.git", "flutter-sdk.git", "julia-general.git", "pkgsrc.git", "nixpkgs.git", "ohmyzsh.git"],
          "label_map": {
...
//# sourceMappingURL=_virtual_jekyll-data-legacy--vWzKqW1.js.map
