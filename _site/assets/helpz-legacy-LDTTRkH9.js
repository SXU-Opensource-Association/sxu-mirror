...
(function () {
  ...
  System.register(['./help-legacy-BslKsKd1.js', './_virtual_jekyll-config-legacy-Dzbfs2TU.js', './_virtual_jekyll-data-legacy--vWzKqW1.js', './default-legacy-BBTX4LHI.js'], function (exports, module) {
    'use strict';

    var mirrorId, HighlightJS;
    return {
      setters: [function (module) {
        mirrorId = module.m;
        HighlightJS = module.H;
      }, null, null, null],
      execute: function execute() {
        var __vite_style__ = document.createElement('style');
        __vite_style__.textContent = ".z-help pre.z-tmpl {\n  display: none;\n}";
        ...
        function generateFormConfig(form) {
          ...
          form.querySelectorAll("input[type=checkbox]:not(:checked)")).forEach(function (elm) {
            formData[elm["name"]] = "";
          });
          var conf = {};
          for (var x in formData) {
            conf[x] = formData[x];
            var varConf = GLOBAL_CONFIG.input[x];
            if (!varConf) continue;
            var optConf = null;
            if ("option" in varConf) optConf = varConf.option[formData[x]];else if ("true" in varConf || "false" in varConf) {
              optConf = formData[x] === "on" ? varConf["true"] : varConf["false"];
            }
            if (_typeof(optConf) === "object") Object.assign(conf, optConf);
        ...
        function renderCode(tmpl) {
          ...
          Array.from(document.querySelectorAll("form.z-global")).forEach(function (elm) {
          ...
          var div = tmpl.previousElementSibling;
          var form = div.querySelector("form.z-form");
          ...
          var rendered = mustache.render(tmpl.textContent.trim(), conf, {}, {
            escape: function escape(x) {
              return x;
            }
          });
          try {
            var lang = tmpl.attributes.getNamedItem("z-lang");
            if (lang && HighlightJS.getLanguage(lang.value)) {
              rendered = HighlightJS.highlight(rendered, {
                language: lang.value
              }).value;
            }
          } catch (err) {
        ...
        var GLOBAL_CONFIG = JSON.parse(atob(document.getElementById("z-config").textContent));
        ...
        renderForm(null);
        var ignoreEventHandler = function ignoreEventHandler(event) {
          return event.preventDefault();
        };
        var _iterator = _createForOfIteratorHelper(document.querySelectorAll("form.z-form")),
          _step;
        try {
...
//# sourceMappingURL=helpz-legacy-LDTTRkH9.js.map
